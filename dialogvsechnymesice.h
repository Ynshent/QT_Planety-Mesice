#ifndef DIALOGVSECHNYMESICE_H
#define DIALOGVSECHNYMESICE_H

#include <QDialog>
#include <QSqlQueryModel>

namespace Ui {
class DialogVsechnyMesice;
}

class DialogVsechnyMesice : public QDialog
{
    Q_OBJECT

public:
    explicit DialogVsechnyMesice(QWidget *parent = nullptr);
    ~DialogVsechnyMesice();

private slots:
    void VsechnyMesiceZmena();
    void VsechnyMesiceZmena2();
...
private:
    ...
    int objevitel = 0;
    QSqlQueryModel* model_vsechnymesice;
};

#endif // DIALOGVSECHNYMESICE_H
